...
class KODISCLib(xbmcprovider.XBMCMultiResolverContentProvider):
    ...
    def _player(self):
        try:
            playTime = sctop.player.getTime() if sctop.player.isPlayingVideo(
            ) else 0
